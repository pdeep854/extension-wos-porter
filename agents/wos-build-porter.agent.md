...
2. For each build system, open the recipe instruction file — VS Code auto-loads them via `applyTo` when you open the matching manifest file, but you may also read them directly:
   ...
   |---|---|
   | CMake | [wos-build-recipes-cmake](../instructions/wos-build-recipes-cmake.instructions.md) |
   | MSBuild / Visual Studio | [wos-build-recipes-msbuild](../instructions/wos-build-recipes-msbuild.instructions.md) |
   | Cargo (Rust) | [wos-build-recipes-cargo](../instructions/wos-build-recipes-cargo.instructions.md) |
   | Meson | [wos-build-recipes-meson](../instructions/wos-build-recipes-meson.instructions.md) |
   | node-gyp | [wos-build-recipes-nodegyp](../instructions/wos-build-recipes-nodegyp.instructions.md) |
   | Python C extensions | [wos-build-recipes-python](../instructions/wos-build-recipes-python.instructions.md) |
   | Autotools, Make/NMake, Bazel, GN, Premake, SCons, Waf, qmake, xmake, B2, Go/cgo | [wos-build-recipes-misc](../instructions/wos-build-recipes-misc.instructions.md) |
